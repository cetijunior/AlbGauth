...
import { DocumentArrowUpIcon, CalculatorIcon, ArrowRightIcon } from '@heroicons/react/24/outline';
...
const AIAssistantSection = () => {
    ...
    const handleFileUpload = (event) => {
        ...
        if (file) {
            ...
            navigate('/answer', { state: { file } });
        }
    };

    const handleSubmit = () => {
        if (question.trim() || uploadedFile) {
            // Save the question and file to localStorage only when submitting
            localStorage.setItem('lastData', JSON.stringify({ question, file: uploadedFile }));
    ...
    return (
        ...
        >
            ...
            >
                <div className="flex items-center w-full border border-purple-600 hover:border-purple-400 rounded-2xl shadow-sm p-2 bg-gray-800">
                    <input
                        type="text"
