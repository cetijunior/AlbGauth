...
import { DocumentArrowUpIcon, XCircleIcon, ArrowPathIcon, ChevronRightIcon } from '@heroicons/react/24/outline';
...
const UploadSection = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center lg:w-2/4 max-w-4xl mx-auto mb-8 rounded-3xl shadow-lg bg-gray-900 text-white">
                    ...
                    <div className="flex flex-col justify-center items-center space-x-2 mb-4">
                        ...
                        <div className="text-center">
                            <p className="text-center text-gray-400 mb-2 group-hover:text-purple-200 transition-colors duration-300">
                                Upload <span className="font-semibold hover:underline hover:decoration-purple-500">Image</span> or <span className="font-semibold hover:underline hover:decoration-purple-500">PDF</span> to solve questions in it
                            </p>
                            <p className="text-center text-gray-500 text-sm group-hover:text-purple-400 transition-colors duration-300">
                                Ctrl <span className="inline-block border border-purple-600 rounded px-1">⌘</span> + <span className="inline-block border border-purple-600 rounded px-1">V</span> to paste
                            </p>
                        </div>
                    </div>
                ...
                <div className="w-full p-6 bg-gray-800 rounded-xl shadow-inner">
                    ...
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between bg-gray-700 p-4 rounded-lg">
                        ...
                        <div className="flex space-x-2">
                            <button onClick={() => document.getElementById('fileUpload').click()} className="p-2 bg-purple-600 rounded-full text-purple-100 hover:bg-purple-700 transition duration-300">
                                <ArrowPathIcon className="w-5 h-5" />
                            </button>
                            <button onClick={handleRemoveFile} className="p-2 bg-red-600 rounded-full text-red-100 hover:bg-red-700 transition duration-300">
                                <XCircleIcon className="w-5 h-5" />
                            </button>
                        </div>
                    </div>
                    {isUploading && <p className="text-sm text-purple-400 mt-3">Uploading file...</p>}
                </div>
            )}
            ...
            {isRecognizing && <p className="mt-4 text-sm text-purple-400">Recognizing text...</p>}
            {recognizedText && (
            ...
            {cohereAnswer && (
                <div className="mt-6 p-6 bg-purple-900 rounded-xl shadow-md w-full">
                    <h3 className="text-xl font-bold mb-3 text-purple-200">AI Analysis:</h3>
