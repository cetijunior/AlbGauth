...
const features = [
    {
        ...
        icon: '📝',
        highlight: 'Our AI breaks down complex problems into easy-to-follow steps, ensuring you understand the entire solution process. Each step is carefully explained, allowing you to grasp the logic behind the problem-solving approach. This method not only helps you solve the current problem but also builds your problem-solving skills for future challenges.',
    },
    {
    ...
    },
    {
        ...
        icon: '⚡',
        highlight: 'No more waiting around. Get instant answers to your questions and move forward with your studies quickly. Our advanced AI algorithms process your queries in real-time, providing solutions within seconds. This rapid response time allows you to maintain your learning momentum, tackle more problems, and make efficient use of your study time.',
    },
];
...
const AppExplanationSection = () => {
    ...
    return (
        <section className="py-12 px-4 md:px-8 relative" style={{ background: '#000000' }}>
            <ShootingStars />
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="flex flex-col ml-10 lg:flex-row items-start lg:items-center justify-between">
                        ...
                        {features.map((feature, index) => (
                            ...
                            >
                                <h3 className="text-xl md:text-2xl font-semibold mb-2 flex items-center">
                                    <span className="text-2xl md:text-3xl mr-3">{feature.icon}</span> {feature.title}
                                </h3>
