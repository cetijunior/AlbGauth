                ...
                */}
				...
				<div className="bg-gray-900 bg-opacity-80 rounded-lg shadow-lg p-4 sm:p-6 backdrop-filter backdrop-blur-lg">
					<div className="flex flex-wrap justify-center space-x-2 sm:space-x-4 mb-4">
						<button
							className={`px-4 py-2 rounded-full mb-2 sm:mb-0 ${
								mode === "Calculator"
						...
						<>
							<div className="flex flex-wrap justify-center space-x-2 mb-4">
								...
								{["Functions", "ABC", "Equations"].map((set) => (
									<button
										key={set}
										className={`px-3 py-1 rounded flex items-center mb-2 ${
											buttonSet === set
												? "bg-blue-600 text-white"
												: "bg-gray-700 text-gray-300"
										}`}
							...
							{showDropdown && (
								<div className="grid grid-cols-4 sm:grid-cols-10 sm:gap-1 gap-2 mb-4">
									{getButtonSet().map((btn, index) => (
										<button
											key={index}
											className={`bg-blue-600 hover:bg-blue-700 text-white font-semibold py-1 w-20 rounded ${
												buttonSet === "ABC" ? "font-serif" : ""
											}`}
											onClick={() =>
												handleButtonClick(
